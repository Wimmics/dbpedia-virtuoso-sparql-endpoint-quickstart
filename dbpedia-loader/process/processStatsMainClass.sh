...
for class in ${first_level_class[@]}; do
	...
	run_virtuoso_cmd "SPARQL PREFIX void: <http://rdfs.org/ns/void#> WITH <${DOMAIN}/graph/statistics> \
		DELETE { <http://fr.dbpedia.org/abstract_graph/mainclass_level_dbpediafr> void:classPartition ?bn1. \
			?bn1 void:class ${class}. \
			?bn1 prop-fr:levelPartition ?bn2. \
			?bn2 prop-fr:level ?p. \
			?bn2 void:triples ?x. } \
		WHERE { \
			<http://fr.dbpedia.org/abstract_graph/mainclass_level_dbpediafr> void:classPartition ?bn1. \
			?bn1 void:class ${class}. \
			?bn1 prop-fr:levelPartition ?bn2. \
			?bn2 prop-fr:level ?p. \
			?bn2 void:triples ?x. \
	...
	run_virtuoso_cmd "SPARQL PREFIX void: <http://rdfs.org/ns/void#> \
		INSERT INTO <${DOMAIN}/graph/statistics> { \
			<http://fr.dbpedia.org/abstract_graph/mainclass_level_dbpediafr> void:classPartition [ \
				void:class ${class}; \
				prop-fr:levelPartition [ \
					prop-fr:level ?depth; \
					void:triples ?count \
				] \
			] \
	...
	echo "## WKIDATA all"
	run_virtuoso_cmd "SPARQL PREFIX void: <http://rdfs.org/ns/void#> WITH <${DOMAIN}/graph/statistics> \
		DELETE { <http://fr.dbpedia.org/abstract_graph/mainclass_level_wikidata> void:classPartition ?bn1. \
			?bn1 void:class ${class}. \
			?bn1 prop-fr:levelPartition ?bn2. \
			?bn2 prop-fr:level ?p. \
			?bn2 void:triples ?x. } \
		WHERE { \
			<http://fr.dbpedia.org/abstract_graph/mainclass_level_wikidata> void:classPartition ?bn1. \
			?bn1 void:class ${class}. \
			?bn1 prop-fr:levelPartition ?bn2. \
			?bn2 prop-fr:level ?p. \
			?bn2 void:triples ?x. \
	...
	run_virtuoso_cmd "SPARQL PREFIX void: <http://rdfs.org/ns/void#> \
		INSERT INTO <${DOMAIN}/graph/statistics> { \
			<http://fr.dbpedia.org/abstract_graph/mainclass_level_wikidata> void:classPartition [ \
				void:class ${class}; \
				prop-fr:levelPartition [ \
					prop-fr:level ?depth; \
